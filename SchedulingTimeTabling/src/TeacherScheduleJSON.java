...
public class TeacherScheduleJSON {
    private static TeacherScheduleJSON instance;
    private Map<String, JSONObject> profesoresHorarios;

    private TeacherScheduleJSON() {
        profesoresHorarios = new ConcurrentHashMap<>();
    }

    public static synchronized TeacherScheduleJSON getInstance() {
        if (instance == null) {
            instance = new TeacherScheduleJSON();
        }
        return instance;
    }
